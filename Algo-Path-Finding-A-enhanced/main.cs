...
class MainClass {
  public static void Main (string[] args) {
    ...
    print(AStarSearch.ManhattanDistance(new AStarNode(0,0), new AStarNode(0,0) ) == 0);
    print(AStarSearch.ManhattanDistance(new AStarNode(1,1), new AStarNode(2,2) ) == 2);
    print(AStarSearch.ManhattanDistance(new AStarNode(0,0), new AStarNode(6,6) ) == 12);

    print(AStarSearch.DiginalDistance(new AStarNode(0,0), new AStarNode(0,0) ) == 0);
    print(AStarSearch.DiginalDistance(new AStarNode(1,1), new AStarNode(2,2) ) == 1.414);
    print(AStarSearch.DiginalDistance(new AStarNode(0,0), new AStarNode(6,6) ) == 1.414 * 6);
    print(AStarSearch.DiginalDistance(new AStarNode(0,0), new AStarNode(5,2) ) == 3 + 2 * 1.414);
...
public class AStarNodeEqualityComparer : IEqualityComparer<AStarNode> {
  public bool Equals(AStarNode n1, AStarNode n2) {
    if (n1 == null && n2 == null)
      return true;
  ...
  public int GetHashCode(AStarNode n) {
    return (n.X << 4) ^ n.Y;
  }
}
...
public class Grid {
  ...
  public bool IsDigonalWall(AStarNode c, AStarNode d) {
    var n = new AStarNode(c.X+d.X, c.Y+d.Y);
    var n1 = new AStarNode(c.X+d.X, c.Y);
    var n2 = new AStarNode(c.X, c.Y+d.Y);
    return IsWall(n) || IsWall(n1) || IsWall(n2);
  }
...
public class AStarSearch {
  ...
  public bool FindPath(AStarNode start, AStarNode goal) {
    ...
    var closedList = new HashSet<AStarNode>(new AStarNodeEqualityComparer());
    ...
    while (openList.Count > 0) {
      ...
      if (current.Equals(goal)) {
        ...
        foreach(var n in mapGrid.Neighbors(current)) {
          ...
          n.H = DiginalDistance(n, goal) + cross*0.001;
  ...
  public static double ManhattanDistance(AStarNode a, AStarNode b) {
    return Math.Abs(a.X-b.X) + Math.Abs(a.Y-b.Y);
  }

  public static double DiginalDistance(AStarNode a, AStarNode b) {
    double D = 1;
    double D2 = 1.414;
