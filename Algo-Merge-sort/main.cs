...
class MainClass {
  ...
  // not-inplace
  public static void Conbine(int[] list, int leftBegin, int leftEnd, int rightBegin, int rightEnd) {
    int i = leftBegin;
    int j = rightBegin;
    // var C = new int[(leftEnd-leftBegin)+1 + (rightEnd-rightBegin)+1];
